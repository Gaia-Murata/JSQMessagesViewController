    ...
    if (self) {
        ...
        if ([_textView respondsToSelector:@selector(textContainerInset)]) {
            if (bubleType == JSBubbleMessageTypeIncoming) {
                _textView.textContainerInset = UIEdgeInsetsMake(7.0f, 0.0f, 0.0f, 0.0f);
            } else {
                _textView.textContainerInset = UIEdgeInsetsMake(7.0f, 6.0f, 0.0f, 0.0f);
            }
        }
